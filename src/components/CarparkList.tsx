            ...
            return (
              ...
              >
                <div className="flex justify-between items-start gap-1">
                  ...
                  <div className={`px-2.5 py-1.5 rounded-lg text-right min-w-[70px] ${statusColor}`}>
                ...
                <div className="flex flex-wrap items-center justify-between gap-x-3 gap-y-1.5 text-xs text-gray-500 mt-2.5 font-medium">
                  ...
                  <span>💵 {cp.agency === "MALL" ? "Mall Rates" : cp.is_central ? "$1.20/30m" : "$0.60/30m"}</span>
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      >
                        ...
                        {isAlertTracked ? "Alert Configured" : "Track Lots Alert"}
                      </button>
