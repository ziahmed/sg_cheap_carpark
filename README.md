...
- **Live carpark data**: [data.gov.sg](https://data.gov.sg) carpark availability API + HDB static carpark info + URA's official Parking Places dataset (covers community clubs, government buildings, and other URA-regulated carparks) + [OpenStreetMap](https://www.openstreetmap.org) community-mapped named parking locations (fills gaps no government dataset covers) + a curated list of private mall carparks with time-based pricing.
